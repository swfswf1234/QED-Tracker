...
| 服务与 API（8901、后台任务、MySQL 登记索引） | `src/qed_tracker/api/main.py`、`src/qed_tracker/db/`（models/knowledge_repository/migrations） | `docs/design/tracker-service.md`、`docs/adr/0001-tracker-service-architecture.md` | `tests/test_api.py`、`tests/test_selections_api.py`、`tests/test_db_models.py`、`tests/test_cli_architecture.py` |
