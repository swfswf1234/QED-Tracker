...
REQUIRED_CURRENT_DOCS = {
    ...
    Path("docs/architecture/database-private-tables.md"),
    Path("docs/architecture/database-shared-tables.md"),
    ...
    Path("docs/design/download-pipeline.md"),
    Path("docs/design/service-management.md"),
...
REQUIRED_HISTORY_DOCS = {
    ...
    Path("docs/history/baselines/2026-08-review-round-dedup.md"),
    Path("docs/history/baselines/2026-07-acquisition-and-inventory.md"),
    Path("docs/history/baselines/2026-08-tracker-service.md"),
    Path("docs/history/baselines/2026-08-service-lifecycle.md"),
