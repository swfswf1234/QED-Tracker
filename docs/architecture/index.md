...
| [QED-Tracker API 设计文档（8901）](api.md) | Accepted（确认状态：暂定） | Implemented | FastAPI 8901 主线 30 条路由按五组业务域（服务与任务/领域与课程/探索评估与采纳/教程/书籍与渠道）六要素契约 + 非主线 7 条附录一览（代码 37 条）；另含外部接口：Axiom-Flow 消费面（8902） |
