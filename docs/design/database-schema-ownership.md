...
实现状态：Implemented
最后更新：2026-08-12
关联代码：`src/qed_tracker/db/`（models/repository/registry/migrations）、`src/qed_tracker/database.py`
关联测试：`tests/test_db_models.py`、`tests/test_db_registry.py`、`tests/test_resources_api.py`、`tests/test_db_mysql_smoke.py`
